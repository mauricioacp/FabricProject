        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Empresa = table.Column<string>(maxLength: 60, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plano_Recinto_RecintoId",
                        column: x => x.RecintoId,
                        principalTable: "Recinto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Plano_AspNetUsers_appUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(nullable: true),
                    WallSide = table.Column<string>(nullable: true),
                    Distance = table.Column<int>(nullable: false),
                    Width = table.Column<int>(nullable: false),
                    DoorOpening = table.Column<bool>(nullable: false),
                    DoorAxis = table.Column<bool>(nullable: false),
                    RecintoId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Puerta_Recinto_RecintoId",
                        column: x => x.RecintoId,
                        principalTable: "Recinto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ventana_Recinto_RecintoId",
                        column: x => x.RecintoId,
                        principalTable: "Recinto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Plano_RecintoId",
                table: "Plano",
                column: "RecintoId");

            migrationBuilder.CreateIndex(
                name: "IX_Plano_appUserId",
                table: "Plano",
                column: "appUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Puerta_RecintoId",
                table: "Puerta",
                column: "RecintoId");

            migrationBuilder.CreateIndex(
                name: "IX_Ventana_RecintoId",
                table: "Ventana",
                column: "RecintoId");
        }
