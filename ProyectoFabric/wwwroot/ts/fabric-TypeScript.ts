...
class Plano {
    ...
    public Ventanas: any[];
    public Puertas: any[];
    public constructor(Nombre: any, Recinto: any, Ventana, Puertas, userId: any)
    {
        this.userId = userId
        this.Nombre = Nombre,
...
const recinto_alto = (<HTMLInputElement>document.getElementById("recinto_alto")).value;
const recinto_ancho = (<HTMLInputElement>document.getElementById("recinto_ancho")).value;
const ventanas_nombres:any = document.getElementsByClassName("ventanas_nombres"); 
const ventanas_distance: any = document.getElementsByClassName("ventanas_distance");
const ventanas_wallside:any = document.getElementsByClassName("ventanas_wallside");
const ventanas_width:any = document.getElementsByClassName("ventanas_width");
const puertas_nombres:any =  document.getElementsByClassName("puertas_nombres");
const puertas_distance:any = document.getElementsByClassName("puertas_distance");
const puertas_wallside:any =  document.getElementsByClassName("puertas_wallside");
const puertas_width:any = document.getElementsByClassName("puertas_width");
...
for (var a = 0; a < ventanas_distance.length; a++) {
    ...
    let heightWind1 = 10;
    let width_positivo: number = ventanas_width[a].value * -1;
    ...
    if (ventanas_wallside[a].value.toLowerCase() === "e") {
        ...
        leftRoom = 50 + rect.width;
        var wind1 = new fabric.Rect();
        let positivo:number = (parseInt(ventanas_width[a].value)* -1);
        wind1.set({
            name: ventanas_nombres[a].value,
            type: "window",
...
function createWindowForm(objeto, myplanoventanas) {
    ...
    let inputDistance:any = document.createElement('input');
    ...
    let inputWidth:any = document.createElement('input');
    inputWidth.setAttribute("type", "text");
...
function createDoorForm(objeto, myplanopuertas) {
    ...
    let inputDistance:any = document.createElement('input'); // Create Input Field for E-mail
    inputDistance.setAttribute("type", "text");
    ...
    let inputWidth:any = document.createElement('input'); // Create Input Field for Name
    inputWidth.setAttribute("type", "text");
    ...
    let optionOutside:any = document.createElement('option');
    ...
    let optionRight:any = document.createElement('option');
